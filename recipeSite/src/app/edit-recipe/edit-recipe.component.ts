...
export class EditRecipeComponent {
  ...
  this.data.recipe.image = this.iconNumber === 4? "../../assets/food/60.png" : ''
  this.data.recipe.image = this.iconNumber === 5 ? "../../assets/food/50.png" : '';
  this.data.recipe.image = this.iconNumber === 6 ? "../../assets/food/70.png" : '';
  this._recipeService.updateRecipe(this.data.recipe.id,this.data.recipe).subscribe({
      next: (res) => {
        ...
        Swal.fire({
          ...
          icon: "success",
          customClass: {
            icon: 'custom-icon-color' // Apply a custom class to the icon
          }
        });
